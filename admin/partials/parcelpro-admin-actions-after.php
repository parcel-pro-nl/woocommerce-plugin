...
?>
<a href="<?php echo $label_link; ?>" class="button tips parcelpro-label" alt="Print <?= PARCELPRO_SHOPSUNITED ?> verzendlabel" data-tip="Print <?= PARCELPRO_SHOPSUNITED ?> verzendlabel">
...
<a href="<?php echo $track_link; ?>" class="button tips parcelpro-track" alt="Volg <?= PARCELPRO_SHOPSUNITED ?> zending" data-tip="Volg <?= PARCELPRO_SHOPSUNITED ?> zending" target="_blank">
